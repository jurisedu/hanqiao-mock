...
export default function Review() {
  ...
  return (
    <Shell role={learnerRole} nav={learnerNav} title={t3("复习卡", "Review cards", "Kadi za marudio")} sub={t3("复习 Agent · FSRS 间隔重复 · 今日 12 张，剩 4 张 · 离线", "Review Agent · FSRS spaced repetition · 12 today, 4 left · offline", "Wakala wa Marudio · marudio ya FSRS · 12 leo, 4 zimebaki · nje ya mtandao")} net={0}>
