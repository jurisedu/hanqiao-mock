        ...
        <Panel className="span2 in" lift={false}>
          {tab === 2 ? (
            <div className="grid c2" style={{ alignItems: "center" }}>
              ...
              <div><div className="grid-han"><div className="on">茶</div><div>茶</div><div></div><div></div></div><div className="small mute" style={{ marginTop: 10 }}>{t(t3("书写智能体校验笔顺与间架结构；第 2 格「艹」偏窄，请再宽一点。", "The Writing Agent checks stroke order and structure: in box 2 the 艹 is narrow, make it wider.", "Wakala wa Kuandika hukagua mpangilio wa mistari: kisanduku 2, 艹 ni nyembamba, ipanue."))}</div></div>
            </div>
          ) : tab === 0 ? (
